...
export default function App() {
  ...
  const [easyReset, setEasyReset] = useState(0);
        ...
        <div className='topbar-inner'>
          ...
          <div className='logo'>
            ...
            <span className='logo-text'>
              Bestynet<span className='logo-accent'>Portal</span>
            </span>
          </div>
            ...
            {!easyDone && (
              <div className='hero-center'>
                <h1 className='hero-title-sm'>
                  Найдётся другой <span className='hero-accent'>путь</span>
                </h1>
                <p className='hero-sub-sm'>
                  Проверенные конфигурации. Автотест каждые 1–2 часа.
                </p>
              </div>
            )}
            <EasyMode onDone={setEasyDone} resetSignal={easyReset} />
          </main>
        </div>
      )}
